  ...
  <>
    <div className="text-left w-full md:w-2/3 mb-12">
      ...
      <div className="my-2">
        ...
        every element of digital design, from UX/UI, to video editing for social
        media, to HTML/CSS, to graphic design and art direction. Not knowing how
        to do something isn’t a barrier – I’m a fast learner, and my knowledge
        has constantly evolved throughout my career.
      </div>
    </div>
    <div className="mb-12">
